...
date:   		  2016-12-13
excerpt: 		  Let's create a CSS toggle switch that is based an iPhone settings switch
...
{% include media-image.html file="articles/css-toggle-switch/toggle-switch.png" %}
