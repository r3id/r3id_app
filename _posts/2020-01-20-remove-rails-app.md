...
First off we drop our database for the app, you may need to close off any connections that are active if you have already started development see my other article about force dropping a database.
