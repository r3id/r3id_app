...
The issue; Occasionally after importing data into a database, your key sequence can become a little out of sync. To fix this run the little SQL snippet below.
