...
This is why learning how to test your code is a vital skill coding skill you need to have. Today, we'll be taking a look at the basics of coding in Ruby using [TDD (test-driven development)](https://en.wikipedia.org/wiki/Test-driven_development){:target="_blank"} .
