...
# Site settings
 ...
 description: > # this means to ignore newlines until "baseurl:"
              ...
              here. You can edit this line in _config.yml. It
              will appear in your document head meta (for Google
              search results) and in your feed.xml site
              description.
...
`_site` is where Jekyll stores its compiled HTML files. Once built, these files can be uploaded directly to a server for hosting, I would recommend [GitHub Pages](https://pages.github.com/).

*Tip* If using Git, you’ll want to use a <a href="https://help.github.com/articles/ignoring-files/">`.gitignore`</a> file to avoid checking in the compiled `_site` folder.
...
Jekyll itself is a [gem](https://rubygems.org/gems/jekyll) as well many Jekyll plugins including `jekyll-paginate` and `jekyll-feed` which get included in the base site.
